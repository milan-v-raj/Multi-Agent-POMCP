...
MAX_DEPTH = 20                # Look further into the future
NUM_SIMULATIONS = 200        # MORE SIMULATIONS = SMARTER (was 50)
...
class LightweightState:
    ...
    def step(self, action_idx):
        ...
        self.h_vel += acc
        self.h_vel *= 0.95
        next_pos = self.h_pos + self.h_vel # Standard 1 frame step
        ...
        if dist < 30: return 100.0, True
        return -(dist / 100.0) - 0.1, False
