...
class Particle(pygame.sprite.Sprite):
    ...
    def update(self):
        # --- THE FIX: VELOCITY NOISE ---
        # Randomly nudge the velocity every frame.
        # This makes the cloud "cone out" instead of moving in a thin line.
        velocity_noise = np.random.normal(0, 0.3, 2) # Std Dev 0.3 (Jitter amount)
        self.vel += velocity_noise
        
        # Apply Drag (so they don't accelerate to infinity)
        self.vel *= 0.95 

        # Update Position
        self.pos += self.vel
        
        # Add Position Noise (Existing)
...
def main():
    ...
    hunter = Drone(250, 400, BLUE, speed_limit=3)
    ...
    while running:
        ...
        # D. HUNTER (BLUE) - MCTS AI
        # It tries to catch YOU (The Red Drone)
